...
const SESSION_SECRET = process.env.JWT_SECRET || require('./config-old').JWT_SECRET
const db = process.env.DB_CONNECTION_STRING || require('./config-old').DB_CONNECTION_STRING
const PORT = process.env.PORT || require('./config-old').development.port
